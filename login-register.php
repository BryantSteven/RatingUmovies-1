...
if (!isset($_SESSION['access_token'])) {
    $login_button = '<a class="button" href="' . $google_client->createAuthUrl() . '"><<img src="resources\google_login_icon.jpg" style="width: 300px;height: 40px;margin-left: -45px;border-radius: 30px;"/></a>';
}
?>
        ...
        <div class="contenedor__todo">
            <div class="caja__trasera">
                <div class="caja__trasera-login">
                    ...
                    <button id="btn__iniciar-sesion" Type="mail ">Iniciar Sesión</button>
                </div>
            ...
            <div class="contenedor__login-register">
                ...
                <form action="php\login_usuario_be.php" method="POST" class="formulario__login">
                    ...
                    <div class="form-group">
                        <button style="width:300px;border-radius: 30px;">Iniciar Sesión</button>
